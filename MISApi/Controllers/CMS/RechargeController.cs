...
namespace MISApi.Controllers.CMS
{
    ...
    public class RechargeController : BaseController<Recharge>
    {
        ...
        /// <returns></returns>
        [Route("Unauthorized/MIS/CMS/Recharge/Query/ByMemberId/{memberId}/{pageIndex}/{pageSize}", Name = "Unauthorized_MISApi_CMS_Recharge_Query_ByMemberId")]
        [HttpGet]
        public IActionResult Unauthorized_Query_ByMemberId(int memberId, int pageIndex, int pageSize)
        {
            ...
            {
                throw new Exception("MISApi.Controllers.CMS.RechargeController.Unauthorized_Query_ByMemberId", ex);
            }
        }
        /// <summary>
        /// 分页查询充值
