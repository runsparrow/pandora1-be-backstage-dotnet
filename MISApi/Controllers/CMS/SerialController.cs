...
namespace MISApi.Controllers.CMS
{
    ...
    public class SerialController : BaseController<Serial>
    {
        ...
        /// <returns></returns>
        [Route("MIS/CMS/Serial/Create/ToStatus", Name = "MIS_CMS_Serial_Create_ToStatus")]
        [HttpPost]
        [Authorize]
        public IActionResult Create_ToStatus(DTO_EntityToStatus<Serial> dto)
        {
            try
            {
                // Entity空值
                ...
                return ResponseOk(
                    new CreateMode.Request().ToResponse(
                        new SerialService.CreateService().ToStatus(dto.Entity, dto.StatusKey)
                    )
                );
            }
            catch (Exception ex)
            {
                throw new Exception("MISApi.Controllers.CMS.SerialController.Create_ToStatus", ex);
            }
        }
        /// <summary>
        /// 批量创建流水并设置状态
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        [Route("MIS/CMS/Serial/Create/BatchToStatus", Name = "MIS_CMS_Serial_Create_BatchToStatus")]
        [HttpPost]
        [Authorize]
        public IActionResult Create_BatchToStatus(DTO_EntitiesToStatus<Serial> dto)
        {
            try
            {
                // Entities空值
                ...
                return ResponseOk(
                    new CreateMode.Request().ToResponse(
                        new SerialService.CreateService().BatchToStatus(dto.Entities, dto.StatusKey)
                    )
                );
            }
            catch (Exception ex)
            {
                throw new Exception("MISApi.Controllers.CMS.SerialController.Create_BatchToStatus", ex);
            }
        }
        #endregion
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        [Route("MIS/CMS/Serial/Update/ToStatus", Name = "MIS_CMS_Serial_Update_ToStatus")]
        [HttpPost]
        [Authorize]
        public IActionResult Update_ToStatus(DTO_EntityToStatus<Serial> dto)
        {
            try
            {
                // Entity空值
                ...
                return ResponseOk(
                    new UpdateMode.Request().ToResponse(
                        new SerialService.UpdateService().ToStatus(dto.Entity, dto.StatusKey)
                    )
                );
            }
            catch (Exception ex)
            {
                throw new Exception("MISApi.Controllers.CMS.SerialController.Update_ToStatus", ex);
            }
        }
        /// <summary>
        /// 批量编辑并设置状态
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        [Route("MIS/CMS/Serial/Update/BatchToStatus", Name = "MIS_CMS_Serial_Update_BatchToStatus")]
        [HttpPost]
        [Authorize]
        public IActionResult Update_BatchToStatus(DTO_EntitiesToStatus<Serial> dto)
        {
            try
            {
                // Entities空值
                ...
                return ResponseOk(
                    new UpdateMode.Request().ToResponse(
                        new SerialService.UpdateService().BatchToStatus(dto.Entities, dto.StatusKey)
                    )
                );
            }
            catch (Exception ex)
            {
                throw new Exception("MISApi.Controllers.CMS.SerialController.Update_BatchToStatus", ex);
            }
        }
        #endregion
        ...
        /// <returns></returns>
        [Route("Unauthorized/MIS/CMS/Serial/Query/ByMemberId/{memberId}/{pageIndex}/{pageSize}", Name = "Unauthorized_MISApi_CMS_Serial_Query_ByMemberId")]
        [HttpGet]
        public IActionResult Unauthorized_Query_ByMemberId(int memberId, int pageIndex, int pageSize)
        {
            ...
            {
                throw new Exception("MISApi.Controllers.CMS.SerialController.Unauthorized_Query_ByMemberId", ex);
            }
        }
        /// <summary>
        /// 分页查询流水
        ...
        public class TreeMode
        {
            ...
            /// 
            /// </summary>
            public class Request : HttpClients.HttpModes.TreeMode.AntdTreeRequest<Serial>
            {
                /// <summary>
                /// 
                /// </summary>
                /// <param name="entityList"></param>
                /// <returns></returns>
                public override HttpClients.HttpModes.TreeMode.AntdTreeResponse<Serial> ToResponse(List<Serial> entityList)
                {
                    return base.ToResponse(entityList);
                }
            }
            ...
            /// 
            /// </summary>
            public class Response : HttpClients.HttpModes.TreeMode.AntdTreeRequest<Serial>
            {
