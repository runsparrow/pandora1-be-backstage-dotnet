...
namespace MISApi.Controllers.CMS
{
    ...
    public class UploadController : BaseController<Upload>
    {
        ...
        public class TreeMode
        {
            ...
            /// 
            /// </summary>
            public class Request : HttpClients.HttpModes.TreeMode.BootstrapTreeViewRequest<Upload>
            {
                /// <summary>
                /// 
                /// </summary>
                /// <param name="entityList"></param>
                /// <returns></returns>
                public override HttpClients.HttpModes.TreeMode.BootstrapTreeViewResponse<Upload> ToResponse(List<Upload> entityList)
                {
                    return base.ToResponse(entityList);
                }
            }
            ...
            /// 
            /// </summary>
            public class Response : HttpClients.HttpModes.TreeMode.BootstrapTreeViewRequest<Upload>
            {
