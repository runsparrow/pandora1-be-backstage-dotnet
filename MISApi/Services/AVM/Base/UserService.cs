    ...
    public class UserService : BaseService.EF<User, PandoraContext>
    {
        ...
        public class CreateService : UserService
        {
            ...
            public User Execute(User entity)
            {
                ...
                {
                    throw new Exception("MISApi.Services.AVM.Base.UserService.CreateService.Execute", ex);
                }
            }
            /// <summary>
            /// 默认的事务方法
        ...
        public class UpdateService : UserService
        {
            ...
            public User Execute(User entity)
            {
                ...
                {
                    throw new Exception("MISApi.Services.AVM.Base.UserService.UpdateService.Execute", ex);
                }
            }
            /// <summary>
            /// 默认的事务方法
        ...
        public class DeleteService : UserService
        {
            ...
            public User Execute(User entity)
            {
                ...
                {
                    throw new Exception("MISApi.Services.AVM.Base.UserService.DeleteService.Execute", ex);
                }
            }
            /// <summary>
            /// 默认的事务方法
        ...
        public class ColumnsService : UserService
        {
            ...
            public User Single()
            {
                ...
                {
                    throw new Exception("MISApi.Services.AVM.Base.UserService.ColumnsService.Execute", ex);
                }
            }
        }
        ...
        public class RowService : UserService
        {
            ...
            public User ById(int id, params BaseMode.Join[] joins)
            {
                using (PandoraContext context = new PandoraContext())
                {
                    ...
                    {
                        throw new Exception("MISApi.Services.AVM.Base.UserService.RowService.ById", ex);
                    }
                }
            }
        }
        ...
        public class RowsService : UserService
        {
            ...
            public List<User> ByKeyWord(BaseMode.KeyWord keyWord, params BaseMode.Join[] joins)
            {
                ...
                {
                    throw new Exception("MISApi.Services.AVM.Base.UserService.RowsService.ByKeyWord", ex);
                }
            }
            /// <summary>
            /// 分页
            ...
            public List<User> Page(BaseMode.KeyWord keyWord, BaseMode.Join[] joins, BaseMode.Page page, BaseMode.Date[] dates, BaseMode.Sort[] sorts, BaseMode.Status status)
            {
                using (PandoraContext context = new PandoraContext())
                {
                    ...
                    {
                        throw new Exception("MISApi.Services.AVM.Base.UserService.RowsService.Page", ex);
                    }
                }
            }
            /// <summary>
            ...
            public int PageCount(BaseMode.KeyWord keyWord, BaseMode.Join[] joins, BaseMode.Date[] dates, BaseMode.Sort[] sorts, BaseMode.Status status)
            {
                using (PandoraContext context = new PandoraContext())
                {
                    ...
                    {
                        throw new Exception("MISApi.Services.AVM.Base.UserService.RowsService.PageCount", ex);
                    }
                }
            }
            /// <summary>
            ...
            public SummaryEntity PageSummary(BaseMode.KeyWord keyWord, BaseMode.Join[] joins, BaseMode.Date[] dates, BaseMode.Sort[] sorts, BaseMode.Status status)
            {
                using (PandoraContext context = new PandoraContext())
                {
                    ...
                    {
                        throw new Exception("MISApi.Services.AVM.Base.UserService.RowsService.PageSummary", ex);
                    }
                }
            }
        }
        ...
        protected IQueryable<SQLEntity> KeyWordQueryable(IQueryable<SQLEntity> queryable, string keyWord)
        {
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.KeyWordQueryable", ex);
            }
        }
        /// <summary>
        /// 关键字扩展
        ...
        protected IQueryable<SQLEntity> KeyWordExtQueryable(IQueryable<SQLEntity> queryable, string keyWordExt)
        {
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.KeyWordExtQueryable", ex);
            }
        }
        /// <summary>
        /// 日期
        ...
        protected IQueryable<SQLEntity> DateQueryable(IQueryable<SQLEntity> queryable, params BaseMode.Date[] dates)
        {
                ...
                if (dates != null)
                {
                    dates.ToList().ForEach(date =>
                    {
                        if (date.Name.ToLower().Equals("createdatetime"))
                        {
                            queryable = queryable
                                .Where(row =>
                                    row.User.CreateDateTime >= date.MinDate && row.User.CreateDateTime <= date.MaxDate
                                );
                        }
                        if (date.Name.ToLower().Equals("editdatetime"))
                        {
                            queryable = queryable
                                .Where(row =>
                                    row.User.EditDateTime >= date.MinDate && row.User.EditDateTime <= date.MaxDate
                                );
                        }
                    });
                }
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.DateQueryable", ex);
            }
        }
        /// <summary>
        /// 状态
        ...
        protected IQueryable<SQLEntity> StatusQueryable(IQueryable<SQLEntity> queryable, BaseMode.Status status)
        {
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.StatusQueryable", ex);
            }
        }
        /// <summary>
        /// 排序
        ...
        protected IQueryable<SQLEntity> SortQueryable(IQueryable<SQLEntity> queryable, params BaseMode.Sort[] sorts)
        {
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.SortQueryable", ex);
            }
        }
        /// <summary>
        /// 分页
        ...
        protected IQueryable<SQLEntity> PageQueryable(IQueryable<SQLEntity> queryable, BaseMode.Page page)
        {
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.PageQueryable", ex);
            }
        }
        /// <summary>
        /// SQLEntity转换
        ...
        protected User SQLEntityToSingle(SQLEntity entity)
        {
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.SQLEntityToSingle", ex);
            }
        }
        /// <summary>
        /// SQLEntity转换
        ...
        protected List<User> SQLEntityToList(List<SQLEntity> list)
        {
            ...
            {
                throw new Exception("MISApi.Services.AVM.Base.UserService.SQLEntityToList", ex);
            }
        }
