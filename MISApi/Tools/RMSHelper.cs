...
namespace MISApi.Tools
{
    ...
    public class RMSHelper
    {
        ...
        /// 创建一个目录  
        /// </summary>  
        /// <param name="sourceDirectoryPath">原文件夹路径</param>  
        /// <param name="destDirectoryPath">目标文件夹路径</param>  
        public static void MoveDirectory(string sourceDirectoryPath, string destDirectoryPath)
        {
            if (IsExistDirectory(sourceDirectoryPath))
            {
        ...
        public static string[] GetFileNames(string directoryPath)
        {
            ...
            if (IsExistDirectory(directoryPath))
            {
                result = Directory.GetFiles(directoryPath);
            }
            // 获取文件列表  
            return result;
        }
